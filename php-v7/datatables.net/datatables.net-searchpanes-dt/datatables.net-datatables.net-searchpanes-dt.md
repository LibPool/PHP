...
> 标签: datatables, filtering, jquery, search, searchpanes, table
...
- 源码仓库：https://github.com/DataTables/Dist-DataTables-SearchPanes-DataTables.git
- Packagist 页面：https://packagist.org/packages/datatables.net%2Fdatatables.net-searchpanes-dt
...
- Composer 安装：`composer require datatables.net/datatables.net-searchpanes-dt`
- Packagist 仓库：https://repo.packagist.org/p2/datatables.net/datatables.net-searchpanes-dt.json
- 许可证：MIT
