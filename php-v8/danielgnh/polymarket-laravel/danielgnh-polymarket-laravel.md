...
- Packagist 页面：https://packagist.org/packages/danielgnh%2Fpolymarket-laravel
...
- Composer 安装：`composer require danielgnh/polymarket-laravel`
- Packagist 仓库：https://repo.packagist.org/p2/danielgnh/polymarket-laravel.json
- 许可证：MIT
- PHP 要求：^8.2
