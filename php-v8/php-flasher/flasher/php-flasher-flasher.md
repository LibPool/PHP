...
- Packagist 页面：https://packagist.org/packages/php-flasher%2Fflasher
...
- Composer 安装：`composer require php-flasher/flasher`
- Packagist 仓库：https://repo.packagist.org/p2/php-flasher/flasher.json
- 许可证：MIT
- PHP 要求：>=8.2
