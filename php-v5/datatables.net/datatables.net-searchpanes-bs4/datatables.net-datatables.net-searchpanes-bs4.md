...
> 标签: bootstrap, bootstrap4, datatables, filtering, jquery, search, searchpanes, table
...
- 源码仓库：https://github.com/DataTables/Dist-DataTables-SearchPanes-Bootstrap4.git
- Packagist 页面：https://packagist.org/packages/datatables.net%2Fdatatables.net-searchpanes-bs4
...
- Composer 安装：`composer require datatables.net/datatables.net-searchpanes-bs4`
- Packagist 仓库：https://repo.packagist.org/p2/datatables.net/datatables.net-searchpanes-bs4.json
- 许可证：MIT
