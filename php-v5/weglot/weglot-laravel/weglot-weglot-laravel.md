...
- Packagist 页面：https://packagist.org/packages/weglot%2Fweglot-laravel
...
- Composer 安装：`composer require weglot/weglot-laravel`
- Packagist 仓库：https://repo.packagist.org/p2/weglot/weglot-laravel.json
- 许可证：MIT
